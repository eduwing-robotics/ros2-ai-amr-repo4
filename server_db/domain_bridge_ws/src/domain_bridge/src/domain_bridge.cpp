...
#include "teamproject_interfaces/srv/set_mode.hpp"
#include "teamproject_interfaces/srv/dispatch_to_event.hpp"
...
int main(int argc, char ** argv)
{
  ...
  domain_bridge.bridge_service<teamproject_interfaces::srv::SetMode>(
    "robot1/set_mode",
    97,
    73
  );

  domain_bridge.bridge_service<teamproject_interfaces::srv::DispatchToEvent>(
    "robot1/dispatch_to_event",
    97,
    73
  );
